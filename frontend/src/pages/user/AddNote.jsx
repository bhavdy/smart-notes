...
import { ArrowLeft, Save, X, Pin, Star } from 'lucide-react';
  ...
  return (
    <div className="p-8 max-w-4xl mx-auto h-full flex flex-col">
      <div className="flex justify-between items-center mb-6">
        <button onClick={() => navigate(-1)} className="btn btn-ghost flex items-center text-gray-500 hover:text-gray-800">
      ...
      <div className="card p-8 flex-1 bg-white shadow-sm flex flex-col" style={{ backgroundColor: formData.color }}>
        ...
        <div className="flex gap-4 mb-4">
          ...
          <input type="color" name="color" value={formData.color} onChange={handleChange} className="h-10 w-10 p-1 border rounded" title="Note Color" />
        </div>
